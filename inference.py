...
def main():
    ...
    model_folder_path = home + '/chLi/Model/AnySplat/anysplat'
    image_folder = home + '/chLi/Dataset/GS/haizei_1/input/images/'

    if not os.path.exists(model_folder_path):
        model_folder_path = "lhjiang/anysplat"

    # Load the model from Hugging Face
    model = AnySplat.from_pretrained(model_folder_path)
